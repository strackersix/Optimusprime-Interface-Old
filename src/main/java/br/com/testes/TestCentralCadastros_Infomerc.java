...
import br.com.pages.CentralCadastros_Infomerc;

public class TestCentralCadastros_Infomerc  {

	
	CentralCadastros_Infomerc Step = new CentralCadastros_Infomerc();
...
//		Step.Estado("SÃO PAULO");
	...
	// Inclusão
		...
		Assert.assertEquals("Mai-2020 Remuneração R$ 100,00 Test Automation - Valores Remuneração Editar", Step.ValidaValoresInfomerc());
	...
	// Alteração 
		...
		Assert.assertEquals("Mai-2020 Distribuidora R$ -200,00 Test Automation - Valores Alterados Distribuidora Editar", Step.ValidaValoresInfomerc());
