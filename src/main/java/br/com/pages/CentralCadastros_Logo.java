...
public class CentralCadastros_Logo extends BasePage {
	...
	public void GrupoEconomico ( String grupoEconomico ) {
		...
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@class = 'multiselect__option multiselect__option--highlight']/span")));
		driver.findElement(By.xpath("//span[@class = 'multiselect__option multiselect__option--highlight']/span")).click();
	...
	public String ValidaCentroDecisorioAlterado1() {
		...
		WebDriverWait wait = new WebDriverWait(driver,20);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div/div/button[@class = 'base-button white px-auto background-grey']")));
	...
	public void EmailUnitario () throws InterruptedException {
		...
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div/button[@class = 'base-button white px-auto background-grey']")));
		Thread.sleep(3000);
	...
	public static String File = "C:\\Users\\gabriel.souza\\Desktop\\Documentos\\Arquivos\\1Mb.pdf";
	...
	public String ValidaUnid1EmailNotaFiscal () {
		
		WebDriverWait wait = new WebDriverWait(driver,20);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[5]")));
	...
	public void FilaCentralCadastros () throws InterruptedException {
		...
		driver.get("https://centralcadastros-api-hmg.doc88.com.br/");
		WebDriverWait wait1 = new WebDriverWait(driver, 20);
		...
		driver.get("https://centralcadastros-api-hmg.doc88.com.br/horizon/dashboard");
		...
		driver.findElement(By.xpath("//div/div/button")).click();
		driver.get("https://centralcadastros-api-hmg.doc88.com.br/home");
	...
	public void AdicionarNovaLinha () {
		...
		driver.findElement(By.xpath("//div/div/button[@class = 'base-button base-button--fluid flex--self-end background-purple white']")).click();
	...
	public void EditarValoresInfomerc () {
		...
		driver.findElement(By.xpath("(//tr/td/button[@class = 'base-button base-button--link'])[1]")).click();
	...
	public void EditarLocal ( String editarLocal ) {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div/button[@class = 'base-button base-button--regular px-auto background-purple white']")));
    ...
    public void Salvar () {
    	...
    	driver.findElement(By.xpath("//div/div/button[@class= 'base-button base-button--regular px-auto background-purple white']")).click();
	...
	public void ExlcuirCustoLivre () {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[4]")));
		driver.findElement(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[4]")).click();
		WebDriverWait wait2 = new WebDriverWait(driver, 10);
	...
	public void ExlcuirRemuneracao () {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[3]")));
		driver.findElement(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[3]")).click();
		WebDriverWait wait2 = new WebDriverWait(driver, 10);
		wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class = 'base-button background-purple white px-auto mt-1']")));
		driver.findElement(By.xpath("//button[@class = 'base-button background-purple white px-auto mt-1']")).click();
	...
	public void ExlcuirComparativoCativo () {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[2]")));
		driver.findElement(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[2]")).click();
		WebDriverWait wait2 = new WebDriverWait(driver, 10);
		wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class = 'base-button background-purple white px-auto mt-1']")));
		driver.findElement(By.xpath("//button[@class = 'base-button background-purple white px-auto mt-1']")).click();
	...
	public void ExcluirDistribuidora () {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[1]")));
		driver.findElement(By.xpath("(//div/button[@class = 'base-button base-button--regular px-auto background-purple white'])[1]")).click();
		WebDriverWait wait2 = new WebDriverWait(driver, 10);
		wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class = 'base-button background-purple white px-auto mt-1']")));
		driver.findElement(By.xpath("//button[@class = 'base-button background-purple white px-auto mt-1']")).click();
	...
	public void DataVigenciaInicio ( String dataVigenciaInicio ) {
		...
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[1]")).sendKeys(dataVigenciaInicio);
		
	}
	
	public void DataVigenciaFim ( String dataVigenciaFim ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[2]")).sendKeys(dataVigenciaFim);
		
	}

	public void Contraparte ( String contraparte ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[3]")).sendKeys(contraparte);
		
	}
	
	public void NumeroDoContrato ( String numeroDoContrato ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[4]")).sendKeys(numeroDoContrato);
		
	}
	
	public void NumeroDoContrato3 ( String numeroDoContrato ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[5]")).sendKeys(numeroDoContrato);
		
	}
	
	public void Distribuidora ( String distribuidora ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[3]")).sendKeys(distribuidora);
		
	}
	
	public void NumeroAditivo ( String numeroAditivo ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[3]")).sendKeys(numeroAditivo);
		
	}
	
	public void NumeroAditivo2 ( String numeroAditivo ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[4]")).sendKeys(numeroAditivo);
		
	}
	
	public void NumeroDoContrato2 ( String numeroDoContrato ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[3]")).sendKeys(numeroDoContrato);
	...
	public void Cancelar () {
		...
		driver.findElement(By.xpath("//div/button[@class = 'base-button grey base-button--regular base-button--cancel px-auto']")).click();
