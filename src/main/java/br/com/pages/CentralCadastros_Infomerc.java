...
public class CentralCadastros_Infomerc extends BasePage {
	...
	public void EditarValoresInfomerc () {
		...
		driver.findElement(By.xpath("(//td/button[@class = 'base-button base-button--regular px-auto base-button--link'])[1]")).click();
	...
	public void EditarLocal ( String editarLocal ) {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div/button[@class = 'base-button base-button--regular px-auto base-button--regular px-auto background-purple white']")));
    ...
    public void Salvar () {
    	...
    	driver.findElement(By.xpath("//div/button[@class = 'base-button base-button--regular px-auto base-button--regular px-auto background-purple white']")).click();
