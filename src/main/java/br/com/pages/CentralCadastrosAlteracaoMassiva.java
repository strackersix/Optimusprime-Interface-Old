...
public class CentralCadastrosAlteracaoMassiva extends BasePage {
	...
	public String ValidaCentroDecisorioAlterado1() {
		...
		WebDriverWait wait = new WebDriverWait(driver,20);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div/button[@class = 'base-button base-button--regular px-auto white background-grey']")));
	...
	public String  BalancoAutomtico () {
		...
		return driver.findElement(By.xpath("(//div/div//div[@class = 'grey--lighten2 base-form--field--body flex flex--align-center'])[16]")).getText();
		
	}
	
	public String  EncerramentoAutomatico () {
		
		return driver.findElement(By.xpath("(//div/div//div[@class = 'grey--lighten2 base-form--field--body flex flex--align-center'])[17]")).getText();
