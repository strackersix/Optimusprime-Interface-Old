...
public class CentralCadastros_Upload extends BasePage {
	...
	public void UploadArquivo () {
		...
		uploadElement.sendKeys(Parametros.UploadPDFCentralCadastros);
	...
	public void DataVigenciaInicio ( String dataVigenciaInicio ) {
		...
		driver.findElement(By.xpath("(//input[@placeholder = 'DD/MM/AAAA'])[1]")).sendKeys(dataVigenciaInicio);
		
	}
	
	public void DataVigenciaFim ( String dataVigenciaFim ) {
		
		driver.findElement(By.xpath("(//input[@placeholder = 'DD/MM/AAAA'])[2]")).sendKeys(dataVigenciaFim);
		
	}

	public void Contraparte ( String contraparte ) {
		
		driver.findElement(By.xpath("(//div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[1]")).sendKeys(contraparte);
		
	}
	
	public void NumeroDoContrato ( String numeroDoContrato ) {
		
		driver.findElement(By.xpath("(//div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[2]")).sendKeys(numeroDoContrato);
	...
	public void Distribuidora ( String distribuidora ) {
		...
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])")).sendKeys(distribuidora);
		
	}
	
	public void NumeroAditivo ( String numeroAditivo ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])")).sendKeys(numeroAditivo);
		
	}
	
	public void NumeroAditivo2 ( String numeroAditivo ) {
		
		driver.findElement(By.xpath("(//div/div/input[@class = 'base-form--input bwa--single border-grey--lighten4 bra-1 pa-2'])[2]")).sendKeys(numeroAditivo);
